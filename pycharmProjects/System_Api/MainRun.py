...
from Project.finance_management.finance import FinanceM
from Project.ht_management.ht import HtM
from Project.ntj_management.ntj import Ntj
...
def do_TestUnit():
    ...
    testSuit.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(FinanceM))
    testSuit.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(HtM))
    testSuit.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(Ntj))
    #清空测试log与报告
